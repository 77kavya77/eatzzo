document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('confirmLogoutBtn').addEventListener('click', function () {
        window.location.href = '/eatzzo/templates/public/index.html';
    });

    // Other settings buttons (would link to other pages in a real app)
    document.getElementById('editProfileBtn').addEventListener('click', function () {
        window.location.href = '/eatzzo/templates/account/edit_profile.html';
    });

    document.getElementById('paymentMethodsBtn').addEventListener('click', function () {
        window.location.href = '/eatzzo/templates/payments/payment.html';
    });

    document.getElementById('addressesBtn').addEventListener('click', function () {
        window.location.href = '/eatzzo/templates/account/address.html';
    });

    document.getElementById('blockedUsersBtn').addEventListener('click', function () {
        window.location.href = '/eatzzo/templates/account/blocked_user.html';
    });

    document.getElementById('helpCenterBtn').addEventListener('click', function () {
        window.location.href = '/eatzzo/templates/account/help.html';
    });

    document.getElementById('aboutBtn').addEventListener('click', function () {
        window.location.href = '/eatzzo/templates/public/ourstory.html';
    });
});
